...
def ensure_gui_available() -> bool:
    ...
    Returns True if GUI modules import successfully, otherwise exits the process.
    """
    try:
        ...
        msg = (
            ...
            "macOS (Homebrew + pyenv): brew install tcl-tk, then reinstall Python with Tk support."
        )
        logger.error(msg)
        print(msg)
