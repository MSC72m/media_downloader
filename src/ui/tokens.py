...
typography and semantic colour roles across the UI.
...
# status colour again (the audit found status colours scattered + unthemed).   #
# Each maps to a key under the theme's "MediaDownloader" section.              #
# --------------------------------------------------------------------------- #
...
SURFACE_RAISED = "surface_elevated"  # cards / panels above the base
SURFACE_OVERLAY = "surface_overlay"  # dialogs / popovers above cards
