...
from utils.common import sanitize_filename, check_site_connection, check_internet_connection, check_all_services, get_problem_services, is_service_connected, download_file
...
class TestCommonUtilsComprehensive:
    ...
    def test_sanitize_filename_basic(self):
        ...
        assert sanitize_filename("Another_Video-Title with spaces") == "Another_Video-Title with spaces"
