...
def test_command_building():
    ...
    expected = ['.venv/bin/yt-dlp', '--cookies-from-browser', 'chrome', '--quiet', '--no-warnings', '--skip-download', '--no-playlist', '--print', 'title', '--print', 'duration', '--print', 'view_count', '--print', 'upload_date', '--print', 'channel', '--print', 'description', '--print', 'thumbnail', 'https://www.youtube.com/watch?v=test']
    assert cmd == expected
    ...
    expected = ['.venv/bin/yt-dlp', '--cookies-from-browser', 'firefox', '--quiet', '--no-warnings', '--skip-download', '--no-playlist', '--print', 'title', '--print', 'duration', '--print', 'view_count', '--print', 'upload_date', '--print', 'channel', '--print', 'description', '--print', 'thumbnail', 'https://www.youtube.com/watch?v=test']
    assert cmd == expected
    print("✅ Firefox browser command building works")

    # Test no cookies
    cmd = build_command('https://www.youtube.com/watch?v=test')
    expected = ['.venv/bin/yt-dlp', '--quiet', '--no-warnings', '--skip-download', '--no-playlist', '--print', 'title', '--print', 'duration', '--print', 'view_count', '--print', 'upload_date', '--print', 'channel', '--print', 'description', '--print', 'thumbnail', 'https://www.youtube.com/watch?v=test']
    assert cmd == expected
...
def test_complete_workflow_simulation():
    ...
    result = simulate_metadata_fetch('https://www.youtube.com/watch?v=dQw4w9WgXcQ', browser='chrome')
    assert result is not None
