...
class TestRealDownloadOptions:
    """Test real DownloadOptions model."""
...
class TestRealUIState:
    """Test real UIState model."""
...
class TestRealAuthState:
    """Test real AuthState model."""
...
class TestRealButtonState:
    """Test real ButtonState model."""
