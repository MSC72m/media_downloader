...
class TestSystemIntegration:
    ...
    def test_handler_registration_with_real_orchestrator(self, mock_ctk):
        ...
        expected = ['InstagramHandler', 'PinterestHandler', 'SoundCloudHandler', 'TwitterHandler', 'YouTubeHandler']
    ...
    def test_service_detector_integration(self, mock_ctk):
        ...
        assert len(detected_services) >= 3, f"Expected at least 3 services, got {len(detected_services)}"
    ...
    def test_interface_compliance(self, mock_ctk):
        ...
        for interface, implementation in interface_implementations:
            assert isinstance(implementation, interface), f"{implementation.__class__.__name__} should implement {interface.__name__}"
...
class TestSystemEndToEnd:
    ...
    def test_multi_platform_support(self, mock_ctk):
        ...
        assert len(detected_platforms) >= 3, f"Expected at least 3 platforms, got {len(detected_platforms)}"
